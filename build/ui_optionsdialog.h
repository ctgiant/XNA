...
public:
    ...
    DeOxyRiboseAmountField *transactionFee;
    QSpacerItem *horizontalSpacer_Main;
    QCheckBox *xnaAtStartup;
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        transactionFee = new DeOxyRiboseAmountField(tabMain);
        ...
        xnaAtStartup = new QCheckBox(tabMain);
        xnaAtStartup->setObjectName(QString::fromUtf8("xnaAtStartup"));

        verticalLayout_Main->addWidget(xnaAtStartup);
    ...
    void retranslateUi(QDialog *OptionsDialog)
    {
        ...
        xnaAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start DeOxyRibose after logging in to the system.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        xnaAtStartup->setText(QApplication::translate("OptionsDialog", "&Start DeOxyRibose on system login", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the DeOxyRibose client port on the router. This only works when your router supports UPnP and it is enabled.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
        mapPortUpnp->setText(QApplication::translate("OptionsDialog", "Map port using &UPnP", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the DeOxyRibose network through a SOCKS proxy (e.g. when connecting through Tor).", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting DeOxyRibose.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_TOOLTIP
        displayAddresses->setToolTip(QApplication::translate("OptionsDialog", "Whether to show DeOxyRibose addresses in the transaction list or not.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
