...
/**
  DeOxyRibose GUI main class. This class represents the main window of the DeOxyRibose UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class DeOxyRiboseGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit DeOxyRiboseGUI(QWidget *parent = 0);
    ~DeOxyRiboseGUI();
