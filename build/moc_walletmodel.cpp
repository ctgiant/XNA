...
static const char qt_meta_stringdata_TT[] = {
    "TT\0"
};
...
const QMetaObjectExtraData TT::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject TT::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TT,
      qt_meta_data_TT, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &TT::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TT))
